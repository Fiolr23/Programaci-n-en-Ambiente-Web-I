...
// Se inicializa un mensaje vacío
$mensaje = "";

// Se verifica si se enviaron datos por POST
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Se ejecuta la consulta y redirigir con mensaje
    if ($stmt->execute()) {
        // Se redirige a la misma página con un parámetro de éxito
